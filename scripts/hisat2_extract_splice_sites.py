...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--gtf_file',
                        type=FileType('r'),
    ...
    parser.add_argument("-o", '--splice_site',
                        dest='splice_site',
                        help='output for splice_site')

    args = parser.parse_args()
    if not args.gtf_file:
        parser.print_help()
        exit(1)
    extract_splice_sites(gtf_file=args.gtf_file,
                         verbose=args.verbose,
                         splice=args.splice_site)
