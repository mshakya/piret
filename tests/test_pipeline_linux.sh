...
# printf "bin/runPiReT -d tests/test_all -e test_experimental_design.txt \
# -gp tests/data/test_prok.gff -ge tests/data/eukarya_test.gff3 \
# -i tests/test_all/prok_euk_index -k both -m both \
# -fp tests/data/test_prok.fa -fe tests/data/eukarya_test.fa\n"

# bin/runPiReT -d tests/test_all -e test_experimental_design.txt \
# -gp tests/data/test_prok.gff -ge tests/data/eukarya_test.gff3 \
# -i tests/test_all/prok_euk_index -k both -m both \
# -fp tests/data/test_prok.fa -fe tests/data/eukarya_test.fa
...
-i tests/test_all/prok_index -k prokarya -m both \
...
# -i tests/test_all/euk_index -k eukarya -m both \
